                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="gold" id="gold" value="0">
                            </div>
                        </div>
                        ...
                        <center>
                            <div class="col-sm-8 col-sm-offset-2">
                                <div class="form-group">
                                    <img id="image" src="<?= base_url('icons/user_icon.png') ?>" class="img-circle img-thumbnail avatar" width="150px" height="150px">
                ...
                <form role="form" method="post" action="<?= base_url('users/alter') ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="gold"> Ouro: </label>
                                <input type="number" class="form-control" name="gold" id="alter_gold" value="0">
                            </div>
                        </div>
                        ...
                        <center>
                            <div class="col-sm-8 col-sm-offset-2">
                                <div class="form-group">
                                    <img id="alter_image" class="img-circle img-thumbnail avatar" width="150px" height="150px">
