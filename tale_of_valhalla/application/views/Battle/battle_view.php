    ...
    <div class="row row-inside">
        ...
        <div class="col-sm-5" style="padding-left: 0; padding-right: 0;">                              
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= $opponent->username ?></h3>
                </div>
                <div class="box-body">
                    <div class="col-sm-6" style="padding: 0">
                        <div class="col-sm-12">
                            <div class="row row-inside">
                                <div class="col-sm-10">
                                    <div class="progress">
                                        <div id="opponent_health_bar"  class="progress-bar progress-bar-success" role="progressbar"
                                             aria-valuemin="0" aria-valuemax="<?= $opponent->health ?>">
                                ...
                                <div class="col-sm-10">
                                    <div class="progress">
                                        <div id="opponent_mana_bar" class="progress-bar progress-bar-info" role="progressbar"
                                             aria-valuemin="0" aria-valuemax="<?= $opponent->mana ?>">
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Ataque">
                                        <img src="<?= base_url('/icons/attack.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px"><strong>Atq: </strong><span id="opponent_current_attack" style="font-size: 14px;"></span></span>
                                    </div>

                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Defesa">
                                        <span style="float: right;"><img src="<?= base_url('/icons/defense.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px;"><strong>Def: </strong><span id="opponent_current_defense" style="font-size: 14px;"></span></span>
                                    </div>

                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Agilidade">
                                        <img src="<?= base_url('/icons/agility.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px"><strong>Agi: </strong><span id="opponent_current_agility" style="font-size: 14px;"></span>
                                    </div>

                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Inteligência">
                                        <span style="float: right;"><img src="<?= base_url('/icons/intelligence.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px"><strong>Int: </strong><span id="opponent_current_intelligence" style="font-size: 14px;"></span></span>
                                    </div>

                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Chance de Esquiva">
                                        <img src="<?= base_url('/icons/evade.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px"><strong>Esq: </strong><span id="opponent_evade" style="font-size: 14px;"></span></span>
                                    </div>

                                    <div class="col-sm-6" style="margin-bottom: 10px;" data-toggle="popover" data-placement="left" data-trigger="hover" data-content="Chance de Crítico">
                                        <span style="float: right;"><img src="<?= base_url('/icons/critic.png') ?>" style="width: 25px; height: 25px;"> <span style="font-size: 14px"><strong>Crt: </strong><span id="opponent_critic" style="font-size: 14px;"></span></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="img-block">
                                <div class="img-animation">
                                    ...
                                    <i id="enemy_spell_animation" style="margin-top: 20px; margin-left: 150px" hidden></i>
                    ...
                    <div class="col-sm-6">
                        <input type="hidden" id="opponent_id" name="opponent_id" value="<?= $opponent->id ?>">
                        <input type="hidden" id="opponent_class" name="opponent_class" value="<?= $opponent->class_id ?>">
                        <input type="hidden" id="opponent_attack" name="opponent_attack" value="<?= $opponent->attack ?>">
                        <input type="hidden" id="opponent_defense" name="opponent_defense" value="<?= $opponent->defense ?>">
                        <input type="hidden" id="opponent_agility" name="opponent_agility" value="<?= $opponent->agility ?>">
                        <input type="hidden" id="opponent_intelligence" name="opponent_intelligence" value="<?= $opponent->intelligence ?>">
                        <input type="hidden" id="opponent_health" name="opponent_health" value="<?= $opponent->health ?>">
                        <input type="hidden" id="opponent_mana" name="opponent_mana" value="<?= $opponent->mana ?>">
                        <input type="hidden" id="opponent_hp_potions" name="opponent_hp_potions" value="<?= $opponent->hp_potions ?>">
                        <input type="hidden" id="opponent_large_hp_potions" name="opponent_large_hp_potions" value="<?= $opponent->large_hp_potions ?>">
                        <input type="hidden" id="opponent_mp_potions" name="opponent_mp_potions" value="<?= $opponent->mp_potions ?>">
                        <input type="hidden" id="opponent_large_mp_potions" name="opponent_large_mp_potions" value="<?= $opponent->large_mp_potions ?>">
                        <input type="hidden" id="opponent_dexterity_potions" name="opponent_dexterity_potions" value="<?= $opponent->dexterity_potions ?>">
                        <input type="hidden" id="opponent_luck_potions" name="opponent_luck_potions" value="<?= $opponent->luck_potions ?>">

                        <img src="<?= base_url('/characters_images/' . $opponent->class_id . '.png') ?>" class="img-rounded img-thumbnail" style="width: 250px; height: 350px; margin-bottom: 15px; float: right">
                    </div>
                </div>
            </div>
        </div>
